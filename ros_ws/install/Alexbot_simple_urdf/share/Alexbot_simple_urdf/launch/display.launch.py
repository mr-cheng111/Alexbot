...
def generate_launch_description():
    ...
    pkg_robot = get_package_share_directory('Alexbot_simple_urdf')
    urdf_path = os.path.join(pkg_robot, 'urdf', 'Alexbot_simple_urdf.urdf')
    rviz_config_path = os.path.join(pkg_robot, 'rviz', 'Alexbot_simple_urdf.rviz')  # 确认rviz文件路径
